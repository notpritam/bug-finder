        ...
        {submitted && (
          <div className="mb-4 flex flex-wrap items-center gap-2.5 rounded-xl border border-emerald-300/50 bg-emerald-50 px-4 py-3 dark:border-emerald-500/30 dark:bg-emerald-500/10">
            ...
            <button
              ...
              title="Create an account or sign in to view and track filed sessions"
            >
              Sign in to track it
            </button>
          </div>
          ...
          <ul className="flex flex-col gap-1.5">
            {drafts.map((d, i) => (
              ...
              >
                ...
                >
                  <span className="bg-amber-100 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-amber-700 dark:bg-amber-500/15 dark:text-amber-400">
                    Draft
                  </span>
